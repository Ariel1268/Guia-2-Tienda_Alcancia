...
public class PanelMonedas extends JPanel implements ActionListener, ItemListener {
    ...
    public void cambiarCantidad(int pDenominacion, int pCantidad) {
        switch (pDenominacion) {
            case 1000 -> radio1000.setText("" + pCantidad);
            case 50 -> radio50.setText("" + pCantidad);
            case 100 -> radio100.setText("" + pCantidad);
            case 200 -> radio200.setText("" + pCantidad);
            case 500 -> radio500.setText("" + pCantidad);
            default -> {
            }
        }
    }
